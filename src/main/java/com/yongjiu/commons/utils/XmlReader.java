...
public class XmlReader {
    ...
    public static List<Worksheet> getWorksheet(Document document) {
        ...
        for (Element sheet : sheets) {
            ...
            setDataValidation(worksheet, sheet);
    ...
    private static void setDataValidation(Worksheet worksheet, Element sheet) {
        ...
        if (elementList != null && !elementList.isEmpty()) {
            for (Element element : elementList) {
                ...
                DataValidations dataValidation = new DataValidations(valueText, rs[0], rs[1] - 1, cs[0], cs[1],valueText.contains("!"));
                dataValidations.add(dataValidation);
            }
        }
        worksheet.setDataValidationList(dataValidations);
    }
